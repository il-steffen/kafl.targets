...
kafl_fuzz.py -w workdir --redqueen --grimoire --sharedir $SHAREDIR --purge --kernel $KERNEL -p $NB_WORKERS --syx $NB_SYX_WORKERS --initrd $INITRD -ip0 $ip_start_addr-$ip_end_addr